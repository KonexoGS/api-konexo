...
from app.models.pib_models import PibModelSchema
...
@router.get('/info/pib/{country_iso_code}', name='Procure sobre o PIB de um determinado país do mundo', response_model=PibModelSchema | None)
